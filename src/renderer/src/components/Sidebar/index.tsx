            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M8 2v3M16 2v3M3.5 9.5h17M4 4h16a1 1 0 0 1 1 1v15a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1z"
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
                      ...
                      fill="none"
                    />
                    <path d="M12 13v4M10 15h4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none"/>
                  </svg>
                  Pianificazione
                </NavLink>
              </li>
              ...
              <li>
                <NavLink
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('trash') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <li>
                ...
                >
                  <svg className="fill-current" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3 4h18v4H3V4zm2 6h14v10H5V10zm5 3h4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                  </svg>
                  Archivio
                </NavLink>
              </li>
